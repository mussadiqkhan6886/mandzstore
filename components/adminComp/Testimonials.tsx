  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center px-10 mb-4">
        ...
        <button className="bg-black text-white px-3.5 py-3 text-sm cursor-pointer rounded-lg"><Link href={"/admin-dashboard/add-testimonial"}>Add Testimonial</Link></button>
      </div>
