...
const CollectionCard = ({title, link, image}: {title: string, link: string, image: string}) => {
  ...
  return (
    <motion.div variants={variants} whileInView={"show"} initial="hidden" viewport={{once: true, amount: 0.2}} className='overflow-hidden'>
