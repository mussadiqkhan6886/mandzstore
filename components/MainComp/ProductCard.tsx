...
const ProductCard = ({id, name, images, price, slug }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-3">
        ...
        <h4 className="text-gray-700">Rs. {price}</h4>
      </div>

      {/* Add to Cart Button */}
      <button
        className={`absolute bottom-24 left-1/2 -translate-x-1/2 px-5 py-2 bg-white text-black font-semibold rounded-full shadow-md transition-all duration-300 ${
          hover
